...
<body>
  ...
  <div class="metodos">
    ...
    <a onclick="window.location='{{ url("metodos/create") }}'"><button class="btn btn-brand border border-gray-400 rounded ">Añadir metodo</button></a>
              ...
              <table id="example" class="table table-striped table-bordered " style="width:100%">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  ...
                  <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <div class="text-sm text-gray-900">{{$met->level}}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <div class="text-sm text-gray-900">{{$met->order}}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                      <div class="text-sm text-gray-900">{{$met->id_user}}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <a class="btn btn-edit" onclick="window.location='{{ route('metodos.edit', $met->id) }}'"><span stroke-width="1.5" data-feather="edit"></span></a>
