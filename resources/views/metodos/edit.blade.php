...
<head>
  ...
  <title>Actualizar metodos</title>
      ...
      <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
          <div class="px-4 sm:px-0">
            <h3 class="text-lg font-medium leading-6 text-gray-900">Actualizar metodos</h3>
          ...
          <form action="{{ route('metodos.update', $metodo->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="shadow overflow-hidden sm:rounded-md">
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="mt-1">
                      <textarea id="description" value="{{$metodo->description}}" name="description" rows="6" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder="">{{$metodo->description}}</textarea>
                    </div>
                      ...
                      <div class="space-y-1 text-center">
                        ...
                        <div class="flex text-sm text-gray-600">
                          <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                            ...
                            <input id="file-upload" value="{{$metodo->image}}" name="image" type="file" class="sr-only">
                          </label>
                  ...
                  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                    ...
                    <input type="number" value="{{$metodo->level}}" name="level" id="level" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md ">
                  </div>

                  <div class="col-span-6 sm:col-span-3 lg:col-span-2">
                    <label for="state" class="block text-sm font-medium text-gray-700">Orden</label>
                    <input type="number" value="{{$metodo->order}}" name="order" id="order" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md ">
                  </div>
              ...
              <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                ...
                <a class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-gray bg-white-600 hover:bg-white-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 text-gray-700" onclick="window.location.href='{{ url("metodos") }}'">Cancelar</a>
              </div>
            </div>
          </form>
        </div>
