      ...
      <div class="md:grid md:grid-cols-3 md:gap-6">
        <div class="md:col-span-1">
          <div class="px-4 sm:px-0">
            <h3 class="text-lg font-medium leading-6 text-gray-900">Actualización de productos</h3>
              ...
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="mt-1">
                      <textarea id="description_ins" value="{{$producto->description_ins}}" name="description_ins" rows="6"
                      ...
                      <div class="space-y-1 text-center">
                        ...
                        <div class="flex text-sm text-gray-600">
                          <label for="file-upload"
                            ...
                            <input id="file-upload" value="{{$producto->image}}" name="image" type="file" class="sr-only">
                          </label>
                  ...
                  <div class="col-span-6">
                    <label for="street-address" class="block text-sm font-medium text-gray-700">Fecha de
                      creación</label>
                    <input type="date" name="creation_date" value="{{$producto->creation_date}}" id="creation_date" autocomplete="street-address"
                      class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                  </div>
